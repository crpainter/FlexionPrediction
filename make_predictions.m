...
[sub1Feat1T, sub1Feat2T, sub1Feat3T, sub1Feat4T, sub1Feat5T, sub1Feat6T] = ...
    CalcFeatures(test_ecog{1}, numChannels, sr, winLen, winDisp);
...
[sub2Feat1T, sub2Feat2T, sub2Feat3T, sub2Feat4T, sub2Feat5T, sub2Feat6T] = ...
    CalcFeatures(test_ecog{2}, numChannels, sr, winLen, winDisp);
...
[sub3Feat1T, sub3Feat2T, sub3Feat3T, sub3Feat4T, sub3Feat5T, sub3Feat6T] = ...
    CalcFeatures(test_ecog{3}, numChannels, sr, winLen, winDisp);
...
for subj = 1:3 
    ...
    for i = 1:5 
        ...
        fname = strcat( 'svm', num2str(subj), 'Fing', num2str(i) );
        svmmodel = load(fname);
